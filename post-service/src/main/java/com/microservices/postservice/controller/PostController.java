...
public class PostController {
    ...
    public ResponseEntity<?> readPostById(@PathVariable("postId") Long postId) {
    ...
    public ResponseEntity<?> writeComment(@PathVariable("postId") Long postId, @RequestBody RequestCreateComment comment) {
        log.info("Post Service's Controller Layer :: Call writeComment Method!");
        log.info("comment.getPostId(): " + comment.getPostId());
...
//                                                                                                    .postId(comment.getPostId())
    ...
    public ResponseEntity<?> deleteComment(@PathVariable("postId") Long postId) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body(commentService.deleteComment(postId));
    }
