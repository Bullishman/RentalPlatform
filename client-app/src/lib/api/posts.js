...
export const deletePost = postId => client.post(`/post-service/${postId}/delete`);

export const writeComment = ({ 
    postId,
    writer, 
    comment, 
}) => client.post(`/post-service/${postId}/comments`, {
    postId,
    writer, 
    comment
});

export const deleteComment = postId => client.delete(`/post-service/${postId}/comments`); 
